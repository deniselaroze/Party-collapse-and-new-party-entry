...
source("EU OECD/Party_Data_Management_Robustness_0_7.R")
...
g.short$X<-NULL
party.data<-read.csv(file="EU OECD/party_data_robustness_0_7.csv")
party.data$X<-NULL
...
write.csv(file="NPE_robustness_0_7.csv", x=mydf)
...
#rm(list=ls())
mydf<-read.csv(file="NPE_robustness_0_7.csv")
...
stargazer(sum.df, covariate.labels=c("Share Votes NP", "Successful NP (dummy)", "N.Successful NP"  ,"Log % votes collapsed party (T-2)", 
                                     ...
                                     "N. Elections", "Mean Dist. Mag.", "Turnout", "Compulsory voting (dummy)", "East Europe (dummy)", "Threshold", "ENEP"),
                                      label="tab:summary",  out=paste0(bd, "summary_robustness_0_7.tex", sep=""))
...
texreg(file= paste0(bd, "main_models_robustness_0_7.tex", sep=""), 
...
texreg(file= paste0(bd, "control_models_robustness_0_7.tex", sep=""), 
...
texreg(file= paste0(bd, "eeu_models_robustness_0_7.tex", sep=""), 
...
texreg(file= paste0(bd, "count_models_robustness_0_7.tex", sep=""), 
...
# 
# png(filename= paste0(bd, "Boot_share_votes_robustness_0_7.png", sep=""))
# plot(results, index=2)
# dev.off()
# 
# png(filename= paste0(bd, "Boot_location_robustness_0_7.png", sep=""))
...
# 
# png(filename=paste0(bd, "boot_c_vote_robustness_0_7.png", sep=""))
...
# 
# 
# png(filename=paste0(bd, "boot_c_location_robustness_0_7.png", sep=""))
...
ipe
ggsave(filename= paste0(bd, "fptpXsize_robustness_0_7.png", sep=""), height=6, width=6)
...
ipeu
ggsave(filename= paste0(bd, "eeuXlocation_robustness_0_7.png", sep=""), height=6, width=6)
...
ipeu2
ggsave(filename= paste0(bd, "eeuXsize_robustness_0_7.png", sep=""), height=6, width=6)
